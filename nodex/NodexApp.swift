...
struct NodexApp: App {
    ...
    var body: some Scene {
        MenuBarExtra("Nodex", systemImage: "sparkle", isInserted: $showMenuBarIcon) {
            Button("Settings") {
...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func setupDragDetectors() {
        cleanupDragDetectors()
        // Nodex v1 keeps the notch focused on media control; shelf drag-open is disabled.
    }
