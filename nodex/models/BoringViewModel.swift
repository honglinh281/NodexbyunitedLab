...
class BoringViewModel: NSObject, ObservableObject {
    ...
    var nodexBottomRadius: CGFloat {
        nodexMediaPhase.bottomRadius
    }

    func setNodexMediaPhase(_ phase: NodexMediaPhase) {
        nodexMediaPhase = phase
        notchSize = phase.notchSize
        notchState = phase.notchState
    }
