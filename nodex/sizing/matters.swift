...
let nodexHoverNotchSize: CGSize = .init(width: 312, height: 73)
let nodexExpandedNotchSize: CGSize = .init(width: 364, height: 249)
let nodexExpandedLyricsNotchSize: CGSize = .init(width: 364, height: 376)
let openNotchSize: CGSize = nodexExpandedLyricsNotchSize
